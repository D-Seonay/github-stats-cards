  ...
  return (
    <section id="gallery" className="space-y-8 pt-12 border-t border-zinc-900">
      <div className="space-y-1">
        <h2 className="text-[10px] uppercase tracking-[0.3em] font-black italic text-zinc-400">
          00. Visual Library
        </h2>
        <p className="text-xs text-zinc-600 font-mono italic">
          {"//"} Previewing all available environment palettes
        </p>
      </div>
          ...
          return (
            ...
            >
              <div className="flex justify-between items-center mb-3">
                ...
                {isSelected && (
                  <span className="text-[8px] bg-zinc-100 text-zinc-950 px-1 font-black uppercase">
                    Active
                  </span>
                )}
              </div>
