  ...
  const features = [
    {
      ...
      desc: "Terminal-inspired, high-contrast themes designed for developers.",
    },
    {
      icon: <Zap size={20} />,
      title: "Serverless Performance",
      desc: "Aggressive caching and XML minification for instant load times.",
    },
    {
      icon: <Activity size={20} />,
      title: "Real-time Metrics",
      desc: "Live GitHub GraphQL integration for stars, commits, and streaks.",
    },
    {
      icon: <Trophy size={20} />,
      title: "Achievement System",
      desc: "Gamified milestones ranging from Bronze to Diamond tiers.",
    },
    {
      icon: <Palette size={20} />,
      title: "Total Customization",
      desc: "Custom CSS injection, Google Fonts support, and layout toggles.",
    },
    {
      icon: <Code size={20} />,
      title: "Open Source",
      desc: "100% free and open-source. Hosted on Vercel Edge Network.",
    },
  ];
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans selection:bg-emerald-500/30 selection:text-emerald-200 overflow-hidden relative">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 md:py-24 relative z-10">
        <motion.header
          ...
          className="text-center space-y-8 mb-12 md:mb-24"
        >
          <motion.div
            variants={itemVariants}
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-zinc-800 bg-zinc-900/50 text-[10px] uppercase tracking-widest font-bold text-zinc-400 mb-8"
          >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-4xl sm:text-5xl md:text-7xl font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-zinc-100 to-zinc-600"
          >
            STAT-STATS
          </motion.h1>
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto font-mono"
          >
            Generate dynamic, high-tech GitHub statistics cards for your profile
            README. Configured in real-time, rendered instantly.
          </motion.p>
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-sm font-bold uppercase tracking-wider mb-2 text-zinc-200">
                {feature.title}
              </h3>
        ...
        >
          <p>
            Built with Next.js 14, Tailwind CSS, and Vercel Serverless
            Functions.
          </p>
          <div className="mt-4 flex justify-center items-center gap-4">
            <a
              href="https://github.com/D-Seonay/github-stats-cards"
              target="_blank"
