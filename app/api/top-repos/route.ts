import { fetchTopRepos, RateLimitError } from "@/src/github-fetcher";
import { generateTopReposSVG, generateErrorSVG, generateRateLimitSVG } from "@/src/svg-generator";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const svg = generateTopReposSVG(data, themeObj, translations, custom_css, font);
